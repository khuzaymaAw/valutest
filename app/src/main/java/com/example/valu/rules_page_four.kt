...
class rules_page_four : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_rules_page_four)

        val preFixedText: TextView = findViewById(R.id.rules_page_four_text_id)
        preFixedText.setText(Html.fromHtml(getString(R.string.rules_page_four_text)))
        ...
        val video_explanation_page_intent = Intent(this,video_explanation_page::class.java)

        next_arrow_button.setOnClickListener {
            startActivity(video_explanation_page_intent) }
